...
const SphereImageGrid: React.FC<SphereImageGridProps> = ({
  ...
  const renderSpotlightModal = () => {
    ...
    return (
      ...
      >
        ...
        >
          <div className="sphere-modal-image-container">
            <img
              src={selectedImage.src}
              alt={selectedImage.alt}
              className="sphere-modal-image"
            />
            <button
              onClick={() => setSelectedImage(null)}
          ...
          {(selectedImage.title || selectedImage.description) && (
            <div className="sphere-modal-info">
              {selectedImage.title && (
                <h3 className="sphere-modal-title">{selectedImage.title}</h3>
              )}
              {selectedImage.description && (
                <p className="sphere-modal-description">{selectedImage.description}</p>
              )}
            </div>
          )}
        </div>
  ...
  if (!isMounted) {
    return (
      ...
      >
        <div className="sphere-loading-text">Loading...</div>
      </div>
    );
  }
  ...
  if (!images.length) {
    return (
      <div
        className="sphere-empty"
        style={{ width: containerSize, height: containerSize }}
      >
        <div className="sphere-empty-content">
          <p className="sphere-empty-text">No images provided</p>
          <p className="sphere-empty-subtext">Add images to the images prop</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <>
      ...
      >
        <div className="sphere-inner" style={{ zIndex: 10 }}>
